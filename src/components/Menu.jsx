...
const Menu = () => {
  ...
  return (
    <section id="menu" className="min-h-[780px]">
      {/* background */}
      <div className="h-[780px] bg-menu absolute w-full -z-0" />
      ...
      <div className="relative z-10 top-72 lg:top-52">
        ...
        >
          ...
          <motion.p
            ...
            className="text-white/60 capitalize mb-8"
          >
            {subtitle}
          </motion.p>
      ...
      >
        <div className="container mx-auto">
          <div className="lg:-mt-24 min-h-[580px] z-30 mb-8 md:mb-4 xl:mb-0 2xl:mb-10">
            {/* grid */}
                ...
                return (
                  <div key={index}>
                    <div className="flex flex-row lg:flex-col h-full">
                      {/* image */}
                      <div
                        className={`w-[45%] md:w-auto 2xl:max-w-[295px] ${
                          index === 1 || index === 3
                            ? "lg:order-1"
                            : "order-none"
                        }`}
                      ...
                      {/* text */}
                      <div className="bg-[#fff3e4] flex-1 flex flex-col justify-center px-6 lg:max-h-[270px] 2xl:max-w-[295px] 2xl:min-h-[295px]">
